...
class Parameter:    
    prompt = 'Consulte informações sobre o próximo concurso da Loteca em {urls} e retorne os jogos de forma organizada em uma tabela Markdown com uma previsão de resultado para cada jogo.',    
    urls = ['https://blog.guiadaloteria.com.br/loteca/programacao'],
...
class LotecaResponse(BaseModel):
    ...
    periodo: str
    realizacao: str
    tabela: str  # Aqui você pode usar JSON ou texto formatado (ex.: Markdown)
