...
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# IMPOTANTE PARA O PROJETO
# trabalhar com uv
# 1 - install uv;
# 2 - uv init (executar o comando na pasta do projeto)
# 3 - uv add evolutionapi (comando para instalar e adicionar biblioteca ao projeto)
# 4 - .\.venv\Scripts\activate (ativar o ambiente virtual)
# 5 - deactivate (desativar o ambiente virtual)
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
